    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Contribution Form -->
                <form id="editContributionForm" action="<?php echo e(route('contribution.update', ['id' => ':id'])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
</div><?php /**PATH C:\Projects\hris\hris-app\resources\views/pages/hr/components/contribution_form.blade.php ENDPATH**/ ?>