...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        showToast('Success', "<?php echo e(session('success')); ?>", 'success');
    });
</script>
<?php elseif(session('warning')): ?>
<script>
    document.addEventListener('DOMContentLoaded', function() {
        showToast('Warning', "<?php echo e(session('warning')); ?>", 'warning');
    });
</script>
...
<?php endif; ?><?php /**PATH C:\Projects\hris\hris-app\resources\views/components/notification.blade.php ENDPATH**/ ?>