  ...
  <div class="tab-pane fade <?php echo e($activeType === 'SSS' ? 'show active' : ''); ?>" id="sss" role="tabpanel" aria-labelledby="sss-tab">
    ...
    'search' => request('contribution_type') === 'SSS' ? request('search') : null
                  ...
                  <!-- Reset Button -->
                  <a href="<?php echo e(route('contribution.management')); ?>?contribution_type=SSS" class="btn btn-secondary d-flex align-items-center ms-2">
      ...
      <?php if($sssContributions instanceof \Illuminate\Pagination\LengthAwarePaginator): ?>
      <table class="table table-bordered">
          ...
          <tbody class="align-middle">
              <?php $__empty_1 = true; $__currentLoopData = $sssContributions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contribution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
              <tr>
                  <td class="text-center"><?php echo e($loop->iteration + ($sssContributions->currentPage() - 1) * $sssContributions->perPage()); ?></td>
                  <td><?php echo e($contribution->employee->empSSSNum ?? 'N/A'); ?></td>
      ...
      <?php if($sssContributions->hasPages()): ?>
      <div class="d-flex flex-column align-items-center mt-4 gap-2">
          
          <div>
              <?php echo e($sssContributions->links('pagination::bootstrap-5')); ?>

          </div>
          
          <div class="text-muted small">
              Showing <?php echo e($sssContributions->firstItem()); ?> to <?php echo e($sssContributions->lastItem()); ?> of <?php echo e($sssContributions->total()); ?> results
          </div>

      </div>
      <?php endif; ?>
      <?php endif; ?>
  </div><?php /**PATH C:\Projects\hris\hris-app\resources\views/pages/hr/components/contribution_sss_table.blade.php ENDPATH**/ ?>