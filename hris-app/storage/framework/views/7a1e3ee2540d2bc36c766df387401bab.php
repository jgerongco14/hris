    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="editTrainingForm" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('POST'); ?> <!-- Will be dynamically replaced -->
...
</div><?php /**PATH C:\Projects\hris\hris-app\resources\views/pages/employee/components/training_modal.blade.php ENDPATH**/ ?>