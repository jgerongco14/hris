    ...
    <table class="table table-bordered table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php if($department->programs->isNotEmpty()): ?>
                    <?php $__currentLoopData = $department->programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card-body mb-2 border rounded bg-light">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <form action="<?php echo e(route('departments.removeProgram', ['departmentId' => $department->id, 'programId' => $program->id])); ?>" method="POST" style="margin-left: 10px;">
                                <?php echo csrf_field(); ?>
