                        ...
                        <div class="card-body">
                            ...
                            <div class="row my-3">
                                ...
                                <div class="col">
                                    ...
                                    <span class="profile-text" id="spouseBdateText">{{ $employee->empSpouseBdate ? \Carbon\Carbon::parse($employee->empSpouseBdate)->format('F d, Y') : '' }}</span>
                                    <input type="date" class="form-control profile-input d-none" id="spouseBdateInput" name="empSpouseBdate" value="{{ $employee->empSpouseBdate ? \Carbon\Carbon::parse($employee->empSpouseBdate)->format('Y-m-d') : '' }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
