...
<form method="POST" action="{{ route('addEmployee.store') }}" enctype="multipart/form-data" id="employeeForm" style="display: none;" class="mt-3 mx-3">
    @csrf
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col mb-3">
                    ...
                    <input type="date" class="form-control" id="empBirthdate" name="empBirthdate" value="{{ old('empBirthdate', $employee->empBirthdate ?? '') }}" required>
                </div>
